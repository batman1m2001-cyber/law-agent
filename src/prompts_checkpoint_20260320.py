...
- "dinh_nghia" — CHỈ dùng khi khoản thuần túy định nghĩa khái niệm/thuật ngữ (ví dụ: "X là...", "X được hiểu là..."), KHÔNG dùng cho khoản liệt kê cơ cấu tổ chức hoặc thành phần bắt buộc phải có
- "khong_ap_dung" — khoản CHỈ áp dụng cho ngân hàng có chi nhánh ở nước ngoài, chi nhánh ngân hàng nước ngoài tại Việt Nam, hoặc ngân hàng nước ngoài — KHÔNG áp dụng cho ngân hàng thương mại trong nước như Techcombank. Dấu hiệu nhận biết: khoản chỉ nhắc đến "chi nhánh ở nước ngoài", "chi nhánh ngân hàng nước ngoài", "ngân hàng nước ngoài" mà không có nghĩa vụ nào dành cho ngân hàng thương mại trong nước. Nếu khoản áp dụng cho CẢ ngân hàng trong nước VÀ nước ngoài → KHÔNG dùng "khong_ap_dung".
...
Trả về JSON object:
{{"obligations": [
  {{"dieu": "số điều.khoản", "loai": "bat_buoc|quyen|dinh_nghia|khong_ap_dung", "chu_the_tuong_tac": "Khách hàng/Cơ quan nhà nước/Quản trị nội bộ — mặc định điền Quản trị nội bộ cho mọi khoản bat_buoc/dinh_nghia; để trống chỉ khi khoản hoàn toàn không có yếu tố nội bộ; để trống nếu loai=khong_ap_dung", "chu_the_hoat_dong": "bộ phận chịu trách nhiệm cuối cùng — luôn phải điền; để trống nếu loai=khong_ap_dung"}}
]}}"""
